...
public class FileMonitor
{
  ...
  private void getLocalFilesRecursive( File folder, Map< String, Md5FilePair > list, String prefix ) throws IOException
  {
  ...
  /**
   * A locale helper class to put a file, togehter with its
   * MD5 hash into a key-value map.
   */
